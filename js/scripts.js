    ...
    */
    $('#cform').validate({
        ...
        submitHandler: function() {
            $.ajax({
                url: 'https://formsubmit.co/ajax/a39e53c78f6a1ae6fd67e2b4e6745fcf',
                method: 'post',
                dataType: 'json',
                accepts: 'application/json',
                data: {
                    name: 'name='+ $("#cform").find('input[name="name"]').val(),
                    email: 'email='+ $("#cform").find('input[name="email"]').val(),
                    message: 'message=' + $("#cform").find('textarea[name="message"]').val()
                },
